...
#' 
#' As of version 0.3 mchof is build on top of the parallel library. 
#' 
#' The most important option is probably mc.cores, which sets the number of processes to start. 
#'  
#' @section NA handling:
#'
